...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.tax_rate'
        db.add_column('users_userprofile', 'tax_rate', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.tax_rate'
        db.delete_column('users_userprofile', 'tax_rate')
