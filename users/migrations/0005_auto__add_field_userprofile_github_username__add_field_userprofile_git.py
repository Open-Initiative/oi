...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('users_userprofile', 'github_username', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.github_password'
        db.add_column('users_userprofile', 'github_password', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.github_username'
        db.delete_column('users_userprofile', 'github_username')

        # Deleting field 'UserProfile.github_password'
        db.delete_column('users_userprofile', 'github_password')
