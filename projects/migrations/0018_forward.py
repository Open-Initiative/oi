...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        "Update language for specs order greater than 3 and equal to 1 to language=''"
        orm.Spec.objects.filter(project__parent=None).exclude(order=2).exclude(order=3).update(language="")
