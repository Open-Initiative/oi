...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.progress'
        db.alter_column('projects_project', 'progress', self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        
        # Changing field 'Project.progress'
        db.alter_column('projects_project', 'progress', self.gf('django.db.models.fields.FloatField')())
