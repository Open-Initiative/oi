...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Project.offer_with_tva'
        db.delete_column('projects_project', 'offer_with_tva')

        # Adding field 'Project.offer_with_avt'
        db.add_column('projects_project', 'offer_with_avt', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Project.offer_with_tva'
        db.add_column('projects_project', 'offer_with_tva', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2), keep_default=False)

        # Deleting field 'Project.offer_with_avt'
        db.delete_column('projects_project', 'offer_with_avt')
    ...
    models = {
        ...
        'projects.project': {
            ...
            'offer_with_avt': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '2'}),
            ...
            'tva': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '2'}),
