...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bid.commission'
        db.add_column('projects_bid', 'commission', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Bid.commission'
        db.delete_column('projects_bid', 'commission')
