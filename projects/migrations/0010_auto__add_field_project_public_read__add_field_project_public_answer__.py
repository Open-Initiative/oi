...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.public_read'
        db.add_column('projects_project', 'public_read', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Project.public_answer'
        db.add_column('projects_project', 'public_answer', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Project.public_bid'
        db.add_column('projects_project', 'public_bid', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.public_read'
        db.delete_column('projects_project', 'public_read')

        # Deleting field 'Project.public_answer'
        db.delete_column('projects_project', 'public_answer')

        # Deleting field 'Project.public_bid'
        db.delete_column('projects_project', 'public_bid')
