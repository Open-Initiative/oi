...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GitHubSync'
        db.create_table('projects_githubsync', (
        ...
        db.send_create_signal('projects', ['GitHubSync'])

        # Adding field 'Project.githubid'
        db.add_column('projects_project', 'githubid', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'GitHubSync'
        db.delete_table('projects_githubsync')

        # Deleting field 'Project.githubid'
        db.delete_column('projects_project', 'githubid')
