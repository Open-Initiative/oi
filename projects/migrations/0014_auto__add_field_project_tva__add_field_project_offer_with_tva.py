...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.tva'
        db.add_column('projects_project', 'tva', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Project.tva'
        db.delete_column('projects_project', 'tva')
    ...
    models = {
        ...
        'projects.project': {
            ...
            'offer_with_tva': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '2'}),
