...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'GitHubSync.user'
        db.delete_column('projects_githubsync', 'user_id')

        # Adding field 'GitHubSync.githubowner'
        db.add_column('projects_githubsync', 'githubowner', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'GitHubSync.token'
        db.add_column('projects_githubsync', 'token', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'GitHubSync.user'
        db.add_column('projects_githubsync', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)

        # Deleting field 'GitHubSync.githubowner'
        db.delete_column('projects_githubsync', 'githubowner')

        # Deleting field 'GitHubSync.token'
        db.delete_column('projects_githubsync', 'token')
