...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.avt'
        db.add_column('projects_project', 'avt', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Project.avt'
        db.delete_column('projects_project', 'avt')
    ...
    models = {
        ...
        'projects.project': {
            ...
            'avt': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '2'}),
            'commission': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '2'}),
