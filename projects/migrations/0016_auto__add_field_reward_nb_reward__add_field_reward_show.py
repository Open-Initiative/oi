...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Reward.nb_reward'
        db.add_column('projects_reward', 'nb_reward', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Reward.show'
        db.add_column('projects_reward', 'show', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Reward.nb_reward'
        db.delete_column('projects_reward', 'nb_reward')

        # Deleting field 'Reward.show'
        db.delete_column('projects_reward', 'show')
    ...
    models = {
        ...
        'projects.reward': {
            ...
            'nb_reward': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['projects.Project']"}),
