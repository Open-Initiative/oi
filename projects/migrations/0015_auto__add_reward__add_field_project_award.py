...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Reward'
        db.create_table('projects_reward', (
        ...
        db.send_create_signal('projects', ['Reward'])

        # Adding field 'Project.award'
        db.add_column('projects_project', 'award', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='prices', null=True, to=orm['projects.Reward']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Reward'
        db.delete_table('projects_reward')

        # Deleting field 'Project.award'
        db.delete_column('projects_project', 'award_id')
