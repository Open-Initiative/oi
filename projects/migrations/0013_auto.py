...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field requirements on 'Project'
        db.create_table('projects_project_requirements', (
        ...
        db.create_unique('projects_project_requirements', ['from_project_id', 'to_project_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field requirements on 'Project'
        db.delete_table('projects_project_requirements')
