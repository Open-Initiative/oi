...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Spot.number'
        db.add_column('projects_spot', 'number', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Spot.number'
        db.delete_column('projects_spot', 'number')
